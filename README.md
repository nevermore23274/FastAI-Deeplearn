...
- The `book` folder contains the course book and the `data` folder contains the actual notebooks. Navigate to: 
`http://localhost:8888/`
...
- `podman run --hooks-dir=/usr/share/containers/oci/hooks.d --gpus all -p 8888:8888 -v $(pwd):/workspace/data:z pytorch-jupyter`
